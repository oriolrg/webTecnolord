...
<div>
    <select v-model="selectedany" name="any" v-on:change="obtenirDadesMesAny" required>
     ...
     <ejs-chart id="temperaturaAny" width='100%' height='100%' :title='title' :primaryXAxis='primaryXAxis'>
        <e-series-collection>
            <e-series :dataSource='seriesData' type='Line' xName='data' yName='temperatura' name='Temperatura'> </e-series>
        </e-series-collection>
    </ejs-chart>
    <ejs-chart id="humitatAny" width='100%' height='350px' :title='titlehumitat' :primaryXAxis='primaryXAxis'>
        <e-series-collection>
