<template>
    <div class="container-fluid">
        ...
        <nou-historia-component v-if="this.projecte_id"  @noves_histories="noves_histories" :data_historia="this.searchquery" :projecte_id="this.projecte_id"></nou-historia-component>
