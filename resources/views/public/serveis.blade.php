    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-sm-6">
                <div class="single_services text-center mt-30 active wow fadeIn" data-wow-duration="0.5s" data-wow-delay="0.5s">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="single_services text-center mt-30 active wow fadeIn" data-wow-duration="0.5s" data-wow-delay="1.5s">
                    <div class="services_icon">
 ...
 <!--
            <div class="col-lg-4 col-sm-6">
                <div class="single_services text-center mt-30 wow fadeIn" data-wow-duration="0.5s" data-wow-delay="1.5s">
                    ...
                    <div class="services_content">
                        <h3 class="services_title">Business Consultancy</h3>
