        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="section_title text-center pb-25">
                    ...
                    <h4 class="main_title">Enginyer Informatic</h4>
                </div> <!-- section title -->
            </div>
        </div> <!-- row -->
        <div class="row">
            <div class="col-lg-12">
                <div class="pricing_menu mt-30 pb-30">
                    <ul class="nav justify-content-center" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="active" id="monthly-tab" data-toggle="tab" href="#informatica" role="tab" aria-controls="monthly" aria-selected="true">Informàtica</a>
                        </li>
                        <li class="nav-item">
                            <a id="yearly-tab" data-toggle="tab" href="#habilitats" role="tab" aria-controls="yearly" aria-selected="false">Habilitats</a>
                        </li>
                        <li class="nav-item">
                            <a id="yearly-tab" data-toggle="tab" href="#coneixements" role="tab" aria-controls="yearly" aria-selected="false">Formacions</a>
                        </li>
                    </ul>
                </div> <!-- pricing menu -->
                <!---->
