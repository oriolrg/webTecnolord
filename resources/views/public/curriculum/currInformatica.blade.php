<div class="col-lg-4 col-md-7 col-sm-9">
    <div class="single_services text-center mt-30 active wow fadeIn" data-wow-duration="0.5s" data-wow-delay="1s">
        ...
        <div class="pricing_content">
            <h1>Màster em Engeniería de les Telecos</h1>
            <p>Lorem ipsum dolor sit am consetetur sadi aliquyam erat sed diam voluptua vero eos  accusam et justo duo dolores </p>
            <span  href="" class="main-no-btn">des de 2019</span>
        </div>
    </div>  <!-- single pricing -->
</div>

<div class="col-lg-4 col-md-7 col-sm-9">
    <div class="single_services text-center mt-30 active wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.5s">
        <div class="services_icon">
        ...
        <div class="pricing_content">
            <h1>Grau en enginyeria Informatica</h1>
            <p>Lorem ipsum dolor sit am consetetur sadi aliquyam erat sed diam voluptua vero eos  accusam et justo duo dolores </p>
            <span  href="" class="main-no-btn">Finalitzat el 2016</span>
        </div>
    </div>  <!-- single pricing -->
</div>

<div class="col-lg-4 col-md-7 col-sm-9">
    <div class="single_services text-center mt-30 active wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="1.5s">
        <div class="services_icon">
            <i class="lni lni-graduation"></i>
            <svg xmlns="http://www.w3.org/2000/svg" width="112" height="110" viewBox="0 0 112 110">
                <path class="services_shape" id="Polygon_15" data-name="Polygon 15" d="M51.2,2.329a11,11,0,0,1,9.6,0L96.15,19.478a11,11,0,0,1,5.927,7.466l8.76,38.665a11,11,0,0,1-2.1,9.258l-24.508,30.96A11,11,0,0,1,75.6,110H36.4a11,11,0,0,1-8.625-4.173L3.266,74.867a11,11,0,0,1-2.1-9.258l8.76-38.665a11,11,0,0,1,5.927-7.466Z" fill="#f94f4f"/>
        ...
        <div class="pricing_content">
            <h1>CFGS en Desenvolupament d'aplicacions informàtiques</h1>
            <p>Lorem ipsum dolor sit am consetetur sadi aliquyam erat sed diam voluptua vero eos  accusam et justo duo dolores </p>
            <span  href="" class="main-no-btn">Finalitzat el 2006</span>
        </div>
    </div>  <!-- single pricing -->
</div>
<div class="col-lg-4 col-md-7 col-sm-9">
    <div class="single_services text-center mt-30 active wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="1s">
        <div class="services_icon">
            <i class="lni lni-graduation"></i>
            <svg xmlns="http://www.w3.org/2000/svg" width="112" height="110" viewBox="0 0 112 110">
                <path class="services_shape" id="Polygon_15" data-name="Polygon 15" d="M51.2,2.329a11,11,0,0,1,9.6,0L96.15,19.478a11,11,0,0,1,5.927,7.466l8.76,38.665a11,11,0,0,1-2.1,9.258l-24.508,30.96A11,11,0,0,1,75.6,110H36.4a11,11,0,0,1-8.625-4.173L3.266,74.867a11,11,0,0,1-2.1-9.258l8.76-38.665a11,11,0,0,1,5.927-7.466Z" fill="#f94f4f"/>
        ...
        <div class="pricing_content">
            <h1>Màster de professorat especialitat en tecnología</h1>
            <p>Lorem ipsum dolor sit am consetetur sadi aliquyam erat sed diam voluptua vero eos  accusam et justo duo dolores </p>
